var objectFitImages = (function () {
  ...
  function b(e) {
    var t = (function (t) {
        for (
          var e, r = getComputedStyle(t).fontFamily, n = {};
          null !== (e = o.exec(r));
    ...
    if (!r.img) {
      (r.img = new Image(e.width, e.height)),
        (r.img.srcset = u.call(e, "data-ofi-srcset") || e.srcset),
        (r.img.src = u.call(e, "data-ofi-src") || e.src),
        l.call(e, "data-ofi-src", e.src),
        e.srcset && l.call(e, "data-ofi-srcset", e.srcset),
        ...
        !(function (r) {
          var e = {
            ...
            set: function (t, e) {
              return (
                (r[i].img[e || "src"] = t),
                l.call(r, "data-ofi-" + e, t),
                b(r),
                t
              );
            },
          };
          Object.defineProperty(r, "src", e),
    ...
    !(function (t) {
      ...
      (e.style.backgroundImage =
        'url("' + (r.img.currentSrc || r.img.src).replace(/"/g, '\\"') + '")'),
  ...
  function m(t, e) {
    ...
    for (var n = 0; n < t.length; n++)
      (t[n][i] = t[n][i] || { skipTest: e.skipTest }), b(t[n]);
    r &&
  ...
  return (
    (m.supportsObjectFit = n),
    (m.supportsObjectPosition = c) ||
      ...
      value: function (t) {
        ...
        for (var e = Object(t), r = 1; r < arguments.length; r++) {
          ...
          if (null != n) {
            n = Object(n);
            for (
              var i = Object.keys(Object(n)), o = 0, c = i.length;
              o < c;
              o++
            ) {
              var s = i[o],
    ...
    (Array.from = (function () {
      ...
      return function (t, e, r) {
        ...
        for (
          var c,
            s = g(n.length),
            a = l(this) ? Object(new this(s)) : new Array(s),
            u = 0;
          u < s;

        )
          (c = n[u]),
            (a[u] = o ? (void 0 === i ? o(c, u) : o.call(i, c, u)) : c),
            (u += 1);
        return (a.length = s), a;
      };
    })()),
